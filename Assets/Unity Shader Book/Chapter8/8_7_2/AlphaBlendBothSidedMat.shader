Shader "Unlit/AlphaBlendBothSidedMat"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target{
                ...
                return fixed4(ambient + diffuse,texColor.a * _AlphaScale);//透明度是纹理像素的透明通道和_AlphaScale的乘积
            }
        ...
        //复制原pass得到另一个pass
        //在两个pass中分别使用不同的Cull指令剔除得到不同朝向的渲染图元
        Pass
        {
            Tags{"LightMode" = "ForwardBase"}
            Cull Back//背对摄像机的图元不会被渲染，渲染前面
